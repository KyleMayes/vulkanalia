...
impl fmt::Debug for StructureType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self.0 {
            ...
            1000010000 => write!(f, "NATIVE_BUFFER_ANDROID"),
            1000010001 => write!(f, "SWAPCHAIN_IMAGE_CREATE_INFO_ANDROID"),
            1000010002 => write!(f, "PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_ANDROID"),
            ...
            1000158001 => write!(f, "DRM_FORMAT_MODIFIER_PROPERTIES_EXT"),
            ...
            1000203000 => write!(f, "PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_NV"),
